      ...
      <div className="container">
        <div className="row justify-content-center  ">
          <div className="  d-inline-flex align-items-center  flex-column  ">
            ...
            {/* <NavLink to={"/products"} type="button" className="btn btn-outline-secondary">
              Вторичный
            </NavLink> */}
            <NavLink to={"/products"} type="button" class="btn btn-primary  rounded-0 btn-lg text-uppercase">к покупкам</NavLink>
