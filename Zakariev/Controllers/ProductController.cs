    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ProductsController(ProductsContext context)
        {
            ...
            if (!db.Products.Any())
            {
                ...
                {
                    Name = "Элексир памяти",
                     ImagesUrl= "https://i.ibb.co/mT9TYPT/Muzhskoe-Zelie.png",
        ...
        public async Task<ActionResult<ProductsInBasketPageModel>> Get([FromQuery] int[] array)
        {
            ...
            foreach (int index in array)
            {
                ...
                productsInBasketPageModel.ProductsWithQuantities.ForEach(u => { productsInBasketPageModel.AmountToPay += (u.Price * u.Quantity); });
            }
